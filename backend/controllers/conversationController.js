...
// //         console.log(`ðŸ"Š User ${userId} totalChats incremented`);
// //       } catch (countError) {
// //         console.error(`âŒ Error incrementing totalChats:`, countError);
// //       }
// //     }

// //     // If this is an edit, only add bot message (user message already exists)
// //     if (isEdit) {
// //       console.log(`âœï¸ Edit mode: Only adding bot response`);
...
// //       console.log(`ðŸ'¬ Normal mode: Adding both user and bot messages`);
// //       session.messages.push({
// //         sender: "user",
...
// //     console.log(`âœ… Conversation saved to session ${session._id}`);
...
// //     });
// //   } catch (error) {
// //     console.error("âŒ saveConversation Error:", error);
...
//         timestamp: new Date(),
//       };
//       if (fileMetadata) botMsgObj.file = fileMetadata;
//       session.messages.push(botMsgObj);
//     } else {
//       // Normal flow: add both user and bot messages
//       console.log(`🗨️ Normal mode: Adding user and bot messages`);
...
//         timestamp: new Date(),
//       };
//       if (fileMetadata) userMsgObj.file = fileMetadata;
...
// // Add this new function to handle saving bot response only (for edits/regenerations)
// export const saveBotResponseOnly = async (req, res) => {
//   try {
//     const { userId, sessionId, botMessage, model } = req.body;

//     console.log(`ðŸ'¾ saveBotResponseOnly called for session ${sessionId}`);
...
//     console.log(`âœ… Bot response saved to session ${session._id}`);
...
//     });
//   } catch (error) {
//     console.error("âŒ saveBotResponseOnly Error:", error);
//     res.status(500).json({ error: error.message });
//   }
// };

// // Keep the original saveConversation for normal messages
