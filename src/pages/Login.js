          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <input
                type="email"
                name="email"
                className="w-full px-4 py-3 bg-transparent border-2 border-gray-700 rounded-xl focus:border-indigo-500 text-white placeholder-gray-400"
                value={formData.email}
                onChange={handleChange}
                placeholder="Email Address"
                required
            ...
            >
              <input
                type={showPassword ? "text" : "password"}
                name="password"
                className="w-full px-4 py-3 pr-12 bg-transparent border-2 border-gray-700 rounded-xl focus:border-indigo-500 text-white placeholder-gray-400"
                value={formData.password}
                onChange={handleChange}
                placeholder="Password"
                required
              ...
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-4 top-3.5 text-gray-400 hover:text-indigo-400"
              >
                {showPassword ? '🙈' : '👁️'}
              </button>
            </motion.div>
            ...
            >
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  checked={formData.rememberMe}
                  onChange={handleChange}
                  className="mr-2 w-4 h-4 text-indigo-600 rounded border-2 border-gray-700 bg-transparent"
                />
                <span className="text-gray-300 text-sm">Remember me</span>
              </label>
              <Link
            ...
            <div className="flex justify-center mt-4">
              <ReCAPTCHA
                sitekey="6Lf-Zf8rAAAAAHx07wzuAvvAVFEluuPoeS5vh504"
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-4 rounded-xl font-semibold shadow-lg hover:shadow-2xl transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {loading ? 'Signing In...' : 'Sign In'}
            </motion.button>
          </form>
