...
export default function LiquidEther({
  ...
  const getColors = () => {
    return isDark
      ? ['#5227FF', '#FF9FFC', '#B19EEF'] // Dark theme: blue/purple
      : ['#DEE4E7', '#B8E3E9', '#CED4D7']; // Light theme: light gray-blue tones
  };
  ...
  useEffect(() => {
    ...
    const paletteTex = makePaletteTexture(getColors());
...
`;
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(props) {
        ...
        // Convert cursor size from pixels to normalized coordinates
        const containerWidth = Common.width;
        const containerHeight = Common.height;
        const cursorSizeX = (props.cursor_size / containerWidth) * 2;
        const cursorSizeY = (props.cursor_size / containerHeight) * 2;
